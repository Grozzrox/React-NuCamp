    ...
    render() {
        return (
            ...
            <React.Fragment>
                    ...
                    <ModalBody>
                        <LocalForm onSubmit={values => this.handleSubmit(values)}>
                            ...
                            <div className="form-group" check>
                                ...
                                <Control.textarea model=".comments" id="comments" name="comments" className="form-control" rows="5" />
                            </div>
                ...
                <Button onClick={this.toggleModal} outline color="secondary" size="lg"><i className="fa fa-pencil fa-lg mr-1"></i>Submit Comment</Button>
            </React.Fragment>
        );
    }
}
